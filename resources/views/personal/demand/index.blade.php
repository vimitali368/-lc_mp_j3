        ...
        <section class="content">
            <div class="row">
                <div class="col-2 mb-3">
                    <a href="{{ route('personal.demand.create') }}" type="button"
                                ...
                                @foreach($demands as $demand)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('personal.demand.show', $demand->id) }}"><i
                                                    class="far fa-eye"></i></a></td>
                                        <td class="text-center">
                                            <a href="{{ route('personal.demand.edit', $demand->id) }}"
                                               class="text-success"><i class="fas fa-pencil-alt"></i></a></td>
                                        <td>
                                            <form action="{{ route('personal.demand.delete', $demand->id) }}"
                                                  method="POST">
                                                @csrf
                                                @method('DELETE')
