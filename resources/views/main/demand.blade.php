                            ...
                            <div class="col-md-8 contact-form-wrapper">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6" data-aos="fade-up">
                                        ...
                                        <input type="text" class="form-control" id="fio" name="fio" placeholder="Ваши полные Фамилия Имя Отчество">
                                    </div>
                                    <div class="form-group col-md-6" data-aos="fade-up">
                                        <label for="phone_number">Телефон</label>
                                        <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Ваш мобильный номер телефона">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6" data-aos="fade-up" data-aos-delay="100">
                                        ...
                                        <input type="text" class="form-control" id="location" name="location" placeholder="Где будет проходить фотосессия">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6" data-aos="fade-up">
                                        <label for="suitable_time">Удобная дата и время</label>
                                        <input type="text" class="form-control" id="suitable_time" name="suitable_time"
                                               placeholder="Когда будет проходить мероприятие?">
                                    </div>
                                    <div class="form-group col-md-6" data-aos="fade-up">
                                        <label for="name">Защита от спама</label>
                                        <input type="text" class="form-control" id="name" name="name"
                                               placeholder="Your full name">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-warning btn-lg" data-aos="fade-up" data-aos-delay="300">Отправить заявку</button>
                            </div>
                            <div class="col-md-4 contact-sidebar" data-aos="fade-left">
                                <h5>Связаться с нами</h5>
                                <p>Вам понравились наши работы и вам нужна тематическая фотосессия? Мы готовы помочь вам с понедельника по пятницу с 9 утра по восточному времени до 10 вечера по восточному времени.</p>
